\chapter{Дослідження моделі з вибором місця для авто за сумішшю рівномірного та розподілу Бернулі}
...
\section{Виведення інтегрального рівняння}
...
\section{Перехід до зображення Лапласа}
