...
%% Виставлення шрифт\UTF{0456}в документу
...
%%% Вир\UTF{0456}внювання та переноси %%%
\sloppy
\clubpenalty=10000
\widowpenalty=10000
...
\usepackage{tocloft}
\usepackage{import}
\usepackage{lastpage} % знаходить номер останньо\UTF{0457} стор\UTF{0456}нки за \pageref*{LastPage}~с.
\usepackage{etoolbox}
...
%%% Форматування п\UTF{0456}дпис\UTF{0456}в таблиць та рисунк\UTF{0456}в %%%
\usepackage{ragged2e}
\usepackage{caption}
...
\usepackage{tabulary}
\usepackage{tabularx}
\usepackage{float} 		% пакет для [H]-положення ф\UTF{0456}гур
\usepackage{rotating}	% пакет для перевертання блок\UTF{0456}в
\usepackage{makecell}
\usepackage{multirow} % улучшенное форматирование таблиц

%пакет для налаштування стор\UTF{0456}нки
...
%% блок роботи з к\UTF{0456}льк\UTF{0456}стю рисунк\UTF{0456}в, таблиць \UTF{0456} книжок
...
\usepackage{totcount} 	% робота з п\UTF{0456}драхунком б\UTF{0456}бл\UTF{0456}ограф\UTF{0456}чних посилань
