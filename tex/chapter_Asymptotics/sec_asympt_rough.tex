...
За властивістю перетворення Лапласа $\tilde M_p(s) \rightarrow 0,\; s \rightarrow +\infty$. \todo{Можна навести твердження про границю у правосторонньому секторі, обмеженому двома похилими прямими з обмеженим кутом нахилу, або послатися на формулу Мелліна}
